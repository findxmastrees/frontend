...
//     console.log(map)
    ...
    const url = "https://dapi.kakao.com/v2/local/search/keyword.json?page=1&size=15&query=" + keyword;
    axios.get(url, {
      headers: {
    ...
    <div className={'mapContainer'}>
      ...
      <div className={'middle'}>
        <div className={'input search'}>
          ...
          <input value={keyword} placeholder={'지번, 도로명, 건물명으로 검색'} onChange={(e) => setKeyword(e.target.value)} onKeyPress={onKeyEvent}/>
        </div>
      ...
      <div className={'bottom'}>
        {(keywordList || []).map((item, index) => {
          return(
            <div className={'keywordItem'} key={index} onClick={() => {
      ...
      <div id={'map'}></div>
      {page === 'detail' ? <RegisterLocation location={selectLocation} setPage={setPage}/> : null}
